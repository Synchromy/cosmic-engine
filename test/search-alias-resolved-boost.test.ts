...
describe('KNOBS_HASH_VERSION', () => {
  it('is 29 (…; 24→25 keywordOrFallback knob kof= #3617; 25→26 salience/recency + intent_patterns fold #4415; 26→27 adaptive-return gate + intent fold E5b/F11; 27→28 compiledTruthBoost synthetic-row suppression #4256; 28→29 exact opaque-identifier precedence etp=)', () => {
